...
- `F:\rag-v1` - user-owned LM Studio plugin workspace that can supply local RAG/plugin context when relevant
...
1. Audit the current context surfaces.
   ...
   - If the task involves LM Studio or local retrieval, inspect `F:\rag-v1` before proposing changes
